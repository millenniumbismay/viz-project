...
const RadioFilter = ({ filterName, enums, selectedFilters, setSelectedFilters }) => {
        ...
        {enums.map((value) => (
          <div key={value} className="form-check">
            <input
              ...
              type="radio" // change this from "checkbox" to "radio"
              name={filterName} // all radio buttons in a group should share the same 'name'
              id={value}
